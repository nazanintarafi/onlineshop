    ...
    return(
        <React.Fragment>
            <body style={{
                    ...
                    transition:props.show?'all 2s':'all 0s',zIndex:props.show?'100':"null",overflow:top?"hidden":"null"}}>
                <div className="signIn">
                    <div className="signInContent">
                        <h2>ثبت نام</h2>
                        <form  style={{opacity:top?'1':'0',transition:top?'3s':'null'}}>
                    ...
                    <div className="logIn" style={{height:top?'30%':'100%',top:top?'100%':'180px',bottom:top?'0px':'-150px',transition:top?'3s':'null'}}>
